...
public class MainPrincipal {
	...
	public static void main(String[] args) {
		...
		Arena fortaleza = new Arena(boss);
...
//		
		...
		Thread t2 = new Thread((Runnable) C1);
		Thread t3 = new Thread((Runnable) M1);
		t1.start();
		t2.start();
		t3.start();
